package com.yakkshit.GoogleFit.service;
...
public class MyScheduleReceiver extends BroadcastReceiver {
    ...
    private static final String ALARM_ID = "com.yakkshit.GoogleFit.MyScheduleReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (currentTime - UserPreferences.getLastSync(context) < (REPEAT_TIME * 2) && intent.getAction().equals("com.yakkshit.GoogleFit.START_REFRESH")) {
        ...
        if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED")
                ...
                || intent.getAction().equals("com.yakkshit.GoogleFit.START_REFRESH")){
